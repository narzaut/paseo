...
function isAttachmentDropdownVisible(
  modeAllowsAttachments: boolean,
  attachmentMenuItems: AttachmentMenuItem[],
): boolean {
  return modeAllowsAttachments && attachmentMenuItems.length > 0;
}
        ...
        >
          ...
          <View style={styles.buttonRow}>
            ...
            <View style={styles.leftButtonGroup}>
              <AttachmentDropdown
                visible={isAttachmentDropdownVisible(mode.showAttachments, attachmentMenuItems)}
