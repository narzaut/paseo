...
import { FileBackedHermesRoomService } from "./hermes-room/hermes-room-service.js";
...
export class VoiceAssistantWebSocketServer {
  ...
  private readonly hermesRoomService: FileBackedHermesRoomService;
  ...
  constructor(
    ...
    this.hermesRoomService =
      hermesRoomService ?? new FileBackedHermesRoomService({ paseoHome, logger: this.logger });
  ...
  private createSocketSession(options: SocketSessionOptions): Session {
    return new Session({
      ...
      hermesRoomService: this.hermesRoomService,
